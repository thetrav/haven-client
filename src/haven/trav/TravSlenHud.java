...
public class TravSlenHud extends Widget
{
    ...
    public TravSlenHud(final Coord c, final Widget parent)
    {
        ...
        new IButton(buttonCoord(0, 1), this, Resource.loadimg("jlay/hatButtonLight"), Resource.loadimg("jlay/hatButtonDark")){@Override
        public void click()
        {
    ...
    private void selectMenu(final String string)
    {
        ...
        if(menu != null)
        {
            final MenuGrid menuGrid = ui.root.findchild(MenuGrid.class);
    ...
    private Coord buttonCoord(int column, int row)
    {
        ...
        int buttonWidth = 15;
        int buttonSpace = 3;
        int x = buttonLeft + column * (buttonWidth + buttonSpace);
        int y = buttonTop + row * (buttonWidth + buttonSpace);
    ...
    //  Hide the current active window
        ...
        if(activeWindow == window)
        {
            ...
            {
                if(((SlenChat)activeWindow).userList != null)   ((SlenChat)activeWindow).userList.toggle();
            }
            return;
        }
