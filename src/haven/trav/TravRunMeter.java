...
public class TravRunMeter extends Widget
{
    ...
    static
    {
        ...
        Widget.addtype("speedget", new WidgetFactory()
        {
            public Widget create(Coord c, Widget parent, Object[] args)
            {
                ...
                return (new TravRunMeter(c, parent, cur, max));
            }
        });
    }

    public TravRunMeter(Coord c, Widget parent, int cur, int max)
    {
        super(runCoord(), tsz, parent);
        this.cur = cur;
        this.max = max;
    }

    private static Coord runCoord()
    {
        final Coord hud = TravHud.coord();
        
        return new Coord(hud.x + 604, hud.y - 18);
    }
